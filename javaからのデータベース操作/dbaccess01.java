 ...
 * @author yuya
 */
public class dbaccess01 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
                ...
                db_st.setInt(1, 003);
                db_st.setString(2, "名前");
                db_st.setString(3,"090-1234-5678");
                db_st.setInt(4,40);
                db_st.setString(5, "1991-02-01"); 
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet dbaccess01</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet dbaccess01 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
